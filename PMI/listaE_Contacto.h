...
// Inserta un nuevo contacto en el tope de la pila.
...
// Elimina el contacto del tope de la pila
...
// Muestra todos los contactos almacenados (del último insertado al primero).
